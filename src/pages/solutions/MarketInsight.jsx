      ...
      <div className="mt-14 sm:mt-16 md:mt-20">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-0">
          ...
          {insights.map((item, index) => (
            ...
            >
              <h3 className="text-xl font-semibold leading-snug text-brand sm:text-2xl">
                {item.title}
              </h3>
          ...
          <div className="space-y-10 md:space-y-12">
            ...
            {otherInsights.map((item, index) => (
              <div key={item.title}>
                ...
                <h3 className="mt-2 text-xl font-medium leading-snug text-white sm:text-2xl md:text-3xl">
                  {item.title}
                </h3>
